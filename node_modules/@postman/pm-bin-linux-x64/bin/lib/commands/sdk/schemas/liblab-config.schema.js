    ...
    properties: {
        ...
        workflows: {
            ...
            properties: {
                path: {
                    type: 'string',
                    description: 'A local relative path to your arrazo specification file or ' +
                        'a publicly reachable URL to the arrazo spec file'
                },
                outputName: {
                    type: 'string',
        ...
        customizations: {
            ...
            properties: {
                            ...
                            properties: {
                                ...
                                tokenEndpoint: {
                                    ...
                                    properties: {
                                        path: {
                                            type: 'string',
                                            description: 'The path to use for the oauth token endpoint. ' +
                                                'This is used to retrieve the oauth token from the server'
                                        },
                                        method: {
                                            type: 'string',
                                            enum: [
                                ...
                                refreshBuffer: {
                                    type: 'number',
                                    minimum: 0,
                                    description: 'The buffer time in milliseconds before the token expires ' +
                                        'to refresh it',
                                    default: 1000
                                }
                            },
                        ...
                        enhancedApiSpec: {
                            ...
                            properties: {
                                ...
                                includeOauthEndpoints: {
                                    type: 'boolean',
                                    description: 'Whether to include OAuth endpoints in the enhanced API ' +
                                        'documentation.  Note that the SDK handles calling these endpoints.',
                                    default: false
                                }
                            },
                            additionalProperties: false
                ...
                includeOptionalSnippetParameters: {
                    type: 'boolean',
                    description: 'toggles whether optional parameters are included in code snippets ' +
                        'in generated SDK documentation.',
                    default: true
                },
                inferServiceNames: {
                    type: 'boolean',
            ...
            properties: {
                csharp: {
                    ...
                    properties: {
                        ...
                        validateResponses: {
                            type: 'boolean',
                            description: 'Enable response validation to check for missing required fields ' +
                                'and invalid null values',
                            default: false
                        },
                        authors: {
                            type: 'array',
                            ...
                            description: 'The list of authors who contribute to the SDK ' +
                                '(In TypeScript the first is the only one displayed)'
                        },
                        githubRepoName: {
                            type: 'string',
                        ...
                        ignoreFiles: {
                            ...
                            description: 'List of files that shouldn\'t be produced by liblab, ' +
                                'used for when you want to keep specific files safe from changes'
                        },
                        ...
                        targetBranch: {
                            type: 'string',
                            minLength: 2,
                            description: 'The target to branch off from when opening a PR, ' +
                                'if not specified will default to main branch'
                        },
                        analytics: {
                            type: 'object',
                            properties: {
                                endpoint: {
                                    type: 'string',
                                    description: 'The analytics endpoint URL'
                                },
                                exporter: {
                                    type: 'string',
                                    enum: ['otlp-http', 'console'],
                                    description: 'The exporter type for analytics'
                                },
                                headers: {
                                    type: 'object',
                                    additionalProperties: {
                                    ...
                                    description: 'Additional headers to include in analytics requests'
                                },
                                batchSize: {
                                    type: 'integer',
                                    minimum: 1,
                                    description: 'The batch size for analytics events'
                                },
                                scheduledDelayMillis: {
                                    type: 'integer',
                                    minimum: 0,
                                    description: 'The scheduled delay in milliseconds for analytics export'
                                },
                                exportTimeoutMillis: {
                                    type: 'integer',
                                    minimum: 1,
                                    description: 'The export timeout in milliseconds'
                                }
                            },
                            required: ['endpoint'],
                            additionalProperties: false,
                            description: 'Analytics configuration for the SDK'
                        }
                    },
                    additionalProperties: false,
                ...
                go: {
                    ...
                    properties: {
                        ...
                        analytics: {
                            $ref: '#/properties/languageOptions/properties/csharp/properties/analytics'
                        }
                    },
                    required: [
                        'goModuleName'
                        ...
                        developers: {
                            ...
                            items: {
                                ...
                                properties: {
                                    ...
                                    organizationUrl: {
                                        type: 'string',
                                        description: 'The organization URL of the developer. ' +
                                            'It is acceptable to link to your profile on GitHub or other forges, ' +
                                            'if you do no have a website.'
                                    }
                                },
                                required: [
                                    'name',
                ...
                php: {
                    ...
                    properties: {
                        packageName: {
                            type: 'string',
                            pattern: '^[\\da-z]([._-]?[\\da-z]+)*\\/[\\da-z](([._]|-{1,2})?[\\da-z]+)*$',
                ...
                typescript: {
                    ...
                    properties: {
                        ...
                        denoteCommon: {
                            type: 'boolean',
                            description: 'Should the SDK mark common models with the `Common` postfix? ' +
                                '(Useful when conflicts occur)',
                            default: false
                        },
                        exportClassDefault: {
                            type: 'boolean',
                ...
                enhancedApiSpec: {
                    ...
                    properties: {
                        ...
                        provider: {
                            ...
                            description: 'Selecting the provider will enable the liblab service to generate ' +
                                'the required files for your integration provider'
                        },
                        redocly: {
                            type: 'object',
                            properties: {
                        ...
                        mintlify: {
                            ...
                            properties: {
                                codeSamplesLanguages: {
                                    ...
                                    description: 'Selecting the languages to enhance and include in the mintlify ' +
                                        'integration. The selected languages will override the languages shown ' +
                                        'in the mintlify UI.'
                                }
                            },
                            additionalProperties: false
...
exports.default = liblabConfigSchema;
//# sourceMappingURL=liblab-config.schema.js.map